...
[ExtractTFR1,RestTFR1] = ExtractOneRidge2SubTFR(TFx,fs,s,direction,tf_type,delta_or_Rep,q,tradeoff);
[ExtractTFR2,RestTFR2] = ExtractOneRidge2SubTFR(RestTFR1,fs,s,direction,tf_type,delta_or_Rep,q,tradeoff);
%提取结果绘制
figure
subplot(2,1,1)
...
set(gca,'FontSize',20);
%重构
[Reconstruction1,t] = ITFM(ExtractTFR1,fs,s,direction,tf_type);
figure
subplot(2,2,1)
...
[Reconstruction2,t] = ITFM(ExtractTFR2,fs,s,direction,tf_type);
figure
subplot(2,2,1)
